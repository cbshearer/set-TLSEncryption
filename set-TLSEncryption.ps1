...
### TLS 1.1
    ...
    ## Client
        ...
        New-ItemProperty -path 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client' -name 'Enabled' .\@AudioToastIcon.png-value '1' -PropertyType 'DWord' -Force | Out-Null
